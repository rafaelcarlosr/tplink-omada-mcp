...
describe('tools/index', () => {
    ...
    describe('registerAllTools', () => {
        it('should register all tools with the server', () => {
            ...
            // 327 baseline + 3 group profile CRUD + 2 DHCP reservation write ops + 1 updateClientName + 1 deleteLanProfile + 1 deleteLanNetwork + 1 deleteAcl + 1 modifyOsgAcl + 1 modifyEapAcl + 1 modifyOswAcl + 1 batchDeleteOsgCustomAcls
            expect(mockServer.registerTool).toHaveBeenCalledTimes(340);
        });
    });
});
